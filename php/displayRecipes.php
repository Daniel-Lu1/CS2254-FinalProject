		...
		function search(searchVal){
			var request = $.ajax({
				...
				success: function(callback){
						...
						var str1 = "<tr><td class=\"hiddenURI\" style=\"display:none\">" + callback.hits[0].recipe.label + "</td><td><img src=\"" + callback.hits[0].recipe.img + "\" alt=\"foodpic\"></td><td>"+callback.hits[0].recipe.label+"</td><td>"+ roundCal +"</td><td><ul>";
