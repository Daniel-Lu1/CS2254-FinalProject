...
session_start();
    ...
    header("Location: cscilab.bc.edu/~borisenk/finalproject/index.html");
	exit();
}
else{
echo '<h1>Incorrect Login Information</h1>'
echo '<a href="http://cscilab.bc.edu/~borisenk/finalproject/login.html">Click here to try again.</a>';
}
